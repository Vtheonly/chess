...
export const CONCEPT_TAXONOMY: Record<string, ConceptDefinition> = {
  // ─── TACTICAL MOTIFS ───────────────────────────────────────────────────
  FORK: {
    id: 'FORK', name: 'Fork (Double Attack)', category: 'tactics', icon: '',
  ...
  SKEWER: {
    id: 'SKEWER', name: 'Skewer', category: 'tactics', icon: '',
    description: 'A valuable piece is forced to move, exposing a lesser piece behind it to capture.',
    weightCp: 70,
  },
  DISCOVERED_ATTACK: {
    id: 'DISCOVERED_ATTACK', name: 'Discovered Attack', category: 'tactics', icon: '',
  ...
  OVERLOADED_DEFENDER: {
    id: 'OVERLOADED_DEFENDER', name: 'Overloaded Defender', category: 'tactics', icon: '',
  ...
  PAWN_ISLANDS: {
    id: 'PAWN_ISLANDS', name: 'Pawn Island Multiplicity', category: 'pawn_structure', icon: '',
  ...
  // ─── KING SAFETY ───────────────────────────────────────────────────────
  KING_PAWN_SHIELD: {
    id: 'KING_PAWN_SHIELD', name: 'King Pawn Shield', category: 'king_safety', icon: '',
    description: 'Pawns directly in front of the castled king providing a protective wall.',
    weightCp: 50,
  },
  KING_PAWN_STORM: {
    id: 'KING_PAWN_STORM', name: 'Pawn Storm Underway', category: 'king_safety', icon: '',
